 ...
 */
public class IsoDateConverterTest extends ConverterTestBase<OffsetDateTime> {
	...
	public IsoDateConverterTest() {
		super(new IsoDateConverter(defaultZoneOffset));
	}
	...
	protected Object[] fromStringParameters() {
		...
		return new Object[]{
				createTestCase("2016-05-16",
						OffsetDateTime.of(LocalDate.of(2016, 5, 16), LocalTime.MIDNIGHT, defaultZoneOffset)),
